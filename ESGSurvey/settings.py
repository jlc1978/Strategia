"""
Django settings for ESGSurvey project.
...
WSGI_APPLICATION = 'ESGSurvey.wsgi.application'
...
LOGIN_REDIRECT_URL = "/ESG/login"

LOGOUT_REDIRECT_URL = "/ESG/logout"
