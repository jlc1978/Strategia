...
def introduction(request,id): #id is the chsend survey's svg pth to be used to include outcome color
    ...
    return render(request, "ESG/introduction.html",context)
...
# Identify whether the survey has been taken by seeing if a color has been provided
    ...
    if request.method == "POST":                         
       ...
       # Context for flow digram
        ...
        return render(request, "ESG/results.html",context)


    else:
        return render(request, "ESG/survey.html",context)


@login_required(login_url='login')
def wheel(request):
    return render(request,'ESG/wheel.html')
...
def user_logout(request):
    logout(request)
    return render(request,'ESG/logout.html',)
...
def results_overall(request):
    ...
    return render(request,'ESG/results_overall.html', context)
